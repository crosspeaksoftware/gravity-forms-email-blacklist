...
/**
 * Gravity_Forms_Email_Blacklist class. This class should ideally be used to work with the
 * public-facing side of the WordPress site.
 *
 * If you're interested in introducing administrative or dashboard
 * functionality, then refer to `class-gf_emailblacklist-admin.php`
 *
 * @package Gravity_Forms_Email_Blacklist
 * @author  Tim Howe <timbhowe@gmail.com>
 */

class Gravity_Forms_Email_Blacklist {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'gf_emailblacklist';
	...
	private function __construct() {
		...
		//Filter
		add_filter( 'gform_validation', array( $this, 'gf_email_field_blacklist_error_message' ) );
	 ...
	 * @since    1.0.0
	 */
	public function gf_email_field_blacklist_error_message($validation_result) {
